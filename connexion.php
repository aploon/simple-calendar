    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="POST" action="connexion.php">
          ...
          <input class="form__input" type="text" placeholder="Name" name="name" require>
          <input class="form__input" type="text" placeholder="Email" name="email" require>
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="POST" action="connexion.php">
          ...
          <input class="form__input" type="text" placeholder="Email" name="email" require>
          <input class="form__input" type="password" placeholder="Password" name="password" require><a class="form__link">Forgot your password?</a>
